...
The Day Trip API is a specialized extension of the Partner API (PAPI), designed to provide partners with comprehensive access to Daytrip's unique single-day travel products. This API allows you to seamlessly integrate day trip browsing, searching, and booking functionalities into your applications.

A day trip is a curated travel experience from a central location to a significant destination and back, often including stops at interesting sights along the way. This API provides all the necessary tools to manage the lifecycle of a day trip booking.
...
| 404         | No available Daytrip locations for the given country.  |
...
| `passengers`         | object  | **Required.** Passenger details.                 |
| `leadPassenger`      | object  | **Required.** Contact info for the lead passenger.|
| `pickupLocation`     | object  | **Required.** Details of the pickup location.    |
...
| `passengers`         | object  | A new passenger configuration.                   |
| `pickupLocation`     | object  | A new pickup location object.                    |
...
| `dayTrip` | object | The details of the day trip. See [DayTrip](#daytrip). |
| `pricing` | object | The pricing details for the booking. See [Price](#price). |
| `vehicles` | array | An array of vehicles assigned to the booking. See [Vehicle](#vehicle). |
...
| `coordinates` | object | The geographical coordinates of the location. |
| `coordinates.lat` | float | The latitude of the location. |
| `coordinates.lon` | float | The longitude of the location. |
...
| `location` | object | The location of the itinerary item. See [Location](#location). |
