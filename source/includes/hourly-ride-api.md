...
An hourly ride is a time-based rental service where passengers rent a driver with a vehicle for a specified duration (1-24 hours), starting and ending at the same location. Each search will return multiple hourly ride options that can differ by vehicle type. The service includes 20 km of travel per hour rented.
...
```json
{
    ...
    "options": [
        ...
        {
            "id": "c2f8a915-7b4e-48ab-bc6d-3e8f92ad5c12",
            "type": "Private",
            "englishSpeakingDriver": true,
            "hoursRented": 6,
            "includedKilometers": 120,
        ...
        {
            "id": "d3e9b726-8c5f-59bc-cd7e-4f9g03be6d23",
            "type": "Private",
            "englishSpeakingDriver": true,
            "hoursRented": 6,
            "includedKilometers": 120,
            ...
            "vehicle": {
                "type": "LuxurySedan",
                "maxPassengers": 2,
                "description": "Luxury sedan comparable to a Mercedes-Benz E-Class, up to 2 passengers with luggage.",
                "modelDescription": "Mercedes-Benz E-Class or similar",
                "image": "https://daytrip.imgix.net/site/luxury-sedan.png"
            },
            "luggage": {
                "maxTotalCarryons": 2,
                "maxTotalSuitcases": 2
...
| includeNonEnglishSpeaking | boolean | Optional. Defaults to `true`. When set to `false`, no hourly ride options with non-English-speaking drivers will be included.                                                                                                                                                                                         |
...
| expiresAt       | string                                        | Obsolete! Please use expiresAt property on [HourlyRideOption](#hourlyrideoption). |
| hoursRented     | integer                                       | The number of hours this search query was for.                                     |
| includedKilometers | integer                                    | Total kilometers included in the rental (hoursRented × 20).                        |
