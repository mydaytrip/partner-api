...
| includeMeetingPositions   | boolean | **Deprecated.** Optional. Defaults to `true`. Meeting positions are now always included in the response when applicable, regardless of this parameter.                                                                                                                                                                |
